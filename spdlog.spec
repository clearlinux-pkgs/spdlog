...
Source0  : https://github.com/gabime/spdlog/archive/v1.15.2/spdlog-1.15.2.tar.gz
...
%prep
%setup -q -n spdlog-1.15.2
cd %{_builddir}/spdlog-1.15.2
pushd ..
cp -a spdlog-1.15.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743431399
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libspdlog.so.1.15.2
/usr/lib64/libspdlog.so.1.15
/usr/lib64/libspdlog.so.1.15.2

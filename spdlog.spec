...
Version  : 1.15.0
Release  : 17
URL      : https://github.com/gabime/spdlog/archive/v1.15.0/spdlog-1.15.0.tar.gz
Source0  : https://github.com/gabime/spdlog/archive/v1.15.0/spdlog-1.15.0.tar.gz
...
%prep
%setup -q -n spdlog-1.15.0
cd %{_builddir}/spdlog-1.15.0
pushd ..
cp -a spdlog-1.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731438136
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libspdlog.so.1.15.0
/usr/lib64/libspdlog.so.1.15
/usr/lib64/libspdlog.so.1.15.0

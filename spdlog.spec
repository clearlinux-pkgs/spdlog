...
Source0  : https://github.com/gabime/spdlog/archive/v1.15.1/spdlog-1.15.1.tar.gz
...
%prep
%setup -q -n spdlog-1.15.1
cd %{_builddir}/spdlog-1.15.1
pushd ..
cp -a spdlog-1.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738633884
mkdir -p clr-build
pushd clr-build
...
/usr/include/spdlog/fmt/bundled/base.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libspdlog.so.1.15.1
/usr/lib64/libspdlog.so.1.15
/usr/lib64/libspdlog.so.1.15.1

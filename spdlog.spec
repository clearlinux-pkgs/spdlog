...
Version  : 1.9.1
Release  : 9
URL      : https://github.com/gabime/spdlog/archive/v1.9.1/spdlog-1.9.1.tar.gz
Source0  : https://github.com/gabime/spdlog/archive/v1.9.1/spdlog-1.9.1.tar.gz
...
%prep
%setup -q -n spdlog-1.9.1
cd %{_builddir}/spdlog-1.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627401564
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/spdlog-1.9.1/LICENSE %{buildroot}/usr/share/package-licenses/spdlog/617ee17d495e6cb87f0d74cc2bddffaf5b827b1f
cp %{_builddir}/spdlog-1.9.1/tests/catch.license %{buildroot}/usr/share/package-licenses/spdlog/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
pushd clr-build
%make_install
popd

...
Version  : 1.12.0
Release  : 13
URL      : https://github.com/gabime/spdlog/archive/v1.12.0/spdlog-1.12.0.tar.gz
Source0  : https://github.com/gabime/spdlog/archive/v1.12.0/spdlog-1.12.0.tar.gz
...
%prep
%setup -q -n spdlog-1.12.0
cd %{_builddir}/spdlog-1.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689009581
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libspdlog.so.1.12.0
/usr/lib64/libspdlog.so.1.12

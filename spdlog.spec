...
Version  : 1.10.0
Release  : 11
URL      : https://github.com/gabime/spdlog/archive/v1.10.0/spdlog-1.10.0.tar.gz
Source0  : https://github.com/gabime/spdlog/archive/v1.10.0/spdlog-1.10.0.tar.gz
...
%prep
%setup -q -n spdlog-1.10.0
cd %{_builddir}/spdlog-1.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649102318
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/spdlog-1.10.0/LICENSE %{buildroot}/usr/share/package-licenses/spdlog/617ee17d495e6cb87f0d74cc2bddffaf5b827b1f
cp %{_builddir}/spdlog-1.10.0/tests/catch.license %{buildroot}/usr/share/package-licenses/spdlog/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
pushd clr-build
%make_install
popd

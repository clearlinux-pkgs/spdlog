...
Version  : 1.9.2
Release  : 10
URL      : https://github.com/gabime/spdlog/archive/v1.9.2/spdlog-1.9.2.tar.gz
Source0  : https://github.com/gabime/spdlog/archive/v1.9.2/spdlog-1.9.2.tar.gz
...
%prep
%setup -q -n spdlog-1.9.2
cd %{_builddir}/spdlog-1.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628870513
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/spdlog-1.9.2/LICENSE %{buildroot}/usr/share/package-licenses/spdlog/617ee17d495e6cb87f0d74cc2bddffaf5b827b1f
cp %{_builddir}/spdlog-1.9.2/tests/catch.license %{buildroot}/usr/share/package-licenses/spdlog/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
pushd clr-build
%make_install
popd

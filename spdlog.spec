...
Source0  : https://github.com/gabime/spdlog/archive/v1.5.0.tar.gz
...
%prep
%setup -q -n spdlog-1.5.0
cd %{_builddir}/spdlog-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580410379
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/spdlog-1.5.0/include/spdlog/fmt/bundled/LICENSE.rst %{buildroot}/usr/share/package-licenses/spdlog/a6571b819c2fb290e2bb182e92a7a20d7d42318d
cp %{_builddir}/spdlog-1.5.0/tests/catch.license %{buildroot}/usr/share/package-licenses/spdlog/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
pushd clr-build
%make_install
popd

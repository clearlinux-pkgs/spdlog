...
Version  : 1.15.3
Release  : 20
URL      : https://github.com/gabime/spdlog/archive/v1.15.3/spdlog-1.15.3.tar.gz
Source0  : https://github.com/gabime/spdlog/archive/v1.15.3/spdlog-1.15.3.tar.gz
...
%prep
%setup -q -n spdlog-1.15.3
cd %{_builddir}/spdlog-1.15.3
pushd ..
cp -a spdlog-1.15.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746800450
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libspdlog.so.1.15.3
